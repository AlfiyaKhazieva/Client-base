...
import { ReactComponent as SvgTwo } from './Vector2.svg';
...
function Main () {
    return (
        <>
        <Header text='Привет, будущий партнер!' class={'header__text-main'} />
        <div className='main__container'>
            ...
            <div className='main__carts'>
                <Cart svg={<SvgOne />} class={'cart__main'} text='Самое гибкое решение на российском рынке'/>
                <Cart svg={<SvgTwo />} class={'cart__main'} text='Более 1000 внедрений по России и зарубежью'/>
            ...
            <p className='main__text'>Малый и средний бизнес со сложной логикой. Готовые CRM им не подходят, на свои с нуля не хватает бюджета. <a className='main__link' href="#">Они выбирают «Клиентскую базу» не за красивый интерфейс</a>, а за содержание и возможности. </p>
            ...
            <p className='main__text'>Чтобы реализовать их гениальную логику, не нужно перерабатывать ядро или много программировать. Плюс, им не всегда нужна CRM. </p>
            ...
            <div className='main__cartList'>
                <p className='main__cart-text'>Средний чек наших партнеров за внедрение CRM «Клиентской базы» под ключ — 100 тысяч рублей. На доработках и поддержке за год с одного клиента заработали до миллиона рублей прибыли. </p>
                <div className='main__cartList-container'>
                    ...
                    <div className='main__cartList-interest'>
                        <div className='main__cartList-salary'>
                            <img className='main__cartList-img' src="../../../images/Ellipse3.png" alt="" />
            ...
            <div className='main__cartPrice'>
                <CartPrice src={<Rent />} h2='SAAS-аккаунт' text='от 300 до 12 000 рублей в месяц' />
                <CartPrice src={<Box />} h2='Коробочная лицензия' text='от 13 500 до 126 000 рублей' />
            </div>
            ...
            <RegisterButton text='Стать партнером' class={'registerButton-main'}/>
        </div>
